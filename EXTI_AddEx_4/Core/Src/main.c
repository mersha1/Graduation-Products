...
{
	if ( GPIO_PIN == SW1) {
		flag_SW1 = 1, flag_SW2 = 0, flag_SW3 = 0, flag_SW4 = 0;

		speed--;

	}
	if ( GPIO_PIN == SW2) {
		flag_SW1 = 0, flag_SW2 = 1, flag_SW3 = 0, flag_SW4 = 0;

		speed++;
	}
	if ( GPIO_PIN == SW3) {
		flag_SW1 = 0, flag_SW2 = 0, flag_SW3 = 1, flag_SW4 = 0;

		speed--;

	}
	if ( GPIO_PIN == SW4) {
		flag_SW1 = 0, flag_SW2 = 0, flag_SW3 = 0, flag_SW4 = 1;
