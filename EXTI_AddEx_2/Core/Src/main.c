...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  if( HAL_GPIO_ReadPin(GPIO_SW, SW1 ) == RESET ) flag_SW1 = 1, flag_SW2 = 0, flag_SW3 = 0, flag_SW4 = 0;
	  if( HAL_GPIO_ReadPin(GPIO_SW, SW2 ) == RESET ) flag_SW1 = 0, flag_SW2 = 1, flag_SW3 = 0, flag_SW4 = 0;
