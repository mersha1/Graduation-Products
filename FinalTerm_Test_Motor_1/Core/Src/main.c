...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_7|GPIO_PIN_15|GPIO_PIN_0, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PE7 PE15 PE0 */
  GPIO_InitStruct.Pin = GPIO_PIN_7|GPIO_PIN_15|GPIO_PIN_0;
...
/*	if ( GPIO_PIN == SW1) mp = 999;
	...
	if ( GPIO_PIN == SW1) HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_1);
	else if ( GPIO_PIN == SW2) HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_1);
	else if ( GPIO_PIN == SW3) HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_1);
	else if ( GPIO_PIN == SW4) HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_1);
