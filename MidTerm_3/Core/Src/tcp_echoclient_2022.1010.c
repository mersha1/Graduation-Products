...
//extern char s1[16];
//char *ptr;
//char s_lt[4], s_rt[4], s_ld[4], s_rd[4];
//extern char *s_lt, *s_rt, *s_ld, *s_rd;

char s1[16]={};
char *s_lt = 0, *s_rt = 0, *s_ld = 0, *s_rd = 0;
int lt = 0, rt = 0, ld = 0, rd = 0;
...
//		s1 = str(cp, 'utf-8');
		...
		//		strcpy(s_lt, stork(s1, ","));
		//		strcpy(s_rt, stork(NULL, ","));
		//		strcpy(s_ld, stork(NULL, ","));
		//		strcpy(s_rd, stork(NULL, ","));
